...
function init() {
  ...
  let p6 = document.querySelector('#lightworks2');
  let p7 = document.querySelector('#name-of');
  let p8 = document.querySelector('#sweeps2');
  let p9 = document.querySelector('#listen-up2');
  let p10 = document.querySelector('#yeah-uh');
